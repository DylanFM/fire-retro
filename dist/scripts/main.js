...
},{"./Map":58,"./components/controls":60,"./components/summary":61,"./hexGridLayer":64,"./pointsLayer":65,"./snapshotsBetween":66,"lodash":10,"main-loop":11,"virtual-dom/create-element":25,"virtual-dom/diff":26,"virtual-dom/h":27,"virtual-dom/patch":35}],2:[function(require,module,exports){
...
},{"turf-inside":20}],20:[function(require,module,exports){
...
},{"turf-polygon":23}],23:[function(require,module,exports){
/**
...
},{"./vdom/create-element.js":37}],26:[function(require,module,exports){
var diff = require("./vtree/diff.js")

module.exports = diff

},{"./vtree/diff.js":57}],27:[function(require,module,exports){
var h = require("./virtual-hyperscript/index.js")

module.exports = h

},{"./virtual-hyperscript/index.js":44}],28:[function(require,module,exports){
/*!
...
},{"min-document":2}],33:[function(require,module,exports){
"use strict";
...
},{"../vnode/handle-thunk":46,"../vnode/is-thunk":47,"../vnode/is-vnode":49,"../vnode/is-vtext":50,"../vnode/is-widget":51,"../vnode/vpatch":54,"./diff-props":56,"x-is-array":34}],58:[function(require,module,exports){
'use strict';
...
},{"./config":62,"leaflet":9}],59:[function(require,module,exports){
'use strict';
...
},{"d3-color":4,"d3-scale":5}],60:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/h":27}],61:[function(require,module,exports){
'use strict';
...
function sortByCount(fireTypes) {
  return _lodash2['default'].sortBy(_lodash2['default'].pairs(fireTypes), function (type) {
    return type[1];
  }).reverse();
}
...
var f = (0, _d3TimeFormat.format)('%B %Y');
...
},{"../colourer":59,"../extractFireTypes":63,"d3-time-format":6,"lodash":10,"virtual-dom/h":27}],62:[function(require,module,exports){
'use strict';
...
exports['default'] = {
  endpoint: 'http://10.0.0.34:8000/incidents',
...
},{"lodash":10}],64:[function(require,module,exports){
'use strict';
...
exports['default'] = (function () {
  ...
  var bounds = _lodash2['default'].cloneDeep(_config2['default'].mapBounds),
      hexBounds = _lodash2['default'].flatten(bounds.map(function (c) {
    return c.reverse();
  })),
...
},{"./colourer":59,"./config":62,"lodash":10,"turf-count":19,"turf-featurecollection":21,"turf-hex":22,"turf-point":24}],65:[function(require,module,exports){
'use strict';
...
},{"./colourer":59,"leaflet":9}],66:[function(require,module,exports){
'use strict';
...
},{"./config":62,"d3-time":7,"d3-time-format":6,"d3-xhr":8,"lodash":10,"q":18}]},{},[1])
