...
var getRanges = _interopRequire(require("./ranges"));

console.log(getRanges(2014));

},{"./ranges":3}],2:[function(require,module,exports){
(function (global){
//! moment.js
//! version : 2.9.0
...
module.exports = function (year) {
  ...
  while (month < 12) {
    ...
    ranges.push([date.startOf("month").format(), date.endOf("month").format()]);
    // Next month...
    month++;
  }
